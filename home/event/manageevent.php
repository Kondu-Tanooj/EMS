...
<body>
  ...
  <div class="sidebar">
      ...
      <?php
        ...
        if ($result === false) {
          ...
          echo "SQL query: " . $sql . "<br>";
                ...
                if ($form_name !== NULL) {
                    echo '<a class="active" href="/home/event/forms/public/'.$eventid.'/'.$form_name.'.html" target="fra1">View Forms</a>';
                } else {
                   // echo '<a class="active" href="forms/generate.php?eventid='.$eventid.' target="fra1">View Forms</a>';
                    echo '<a class="active" href="/home/event/forms/generate.php?eventid='.$eventid.'" target="fra1">View Forms</a>';
                }
            } else {
                echo "Event not found.";
            }
    ...
    <div id="certificates" style="display: none;">
      <a class="active"  target="fra1">Generate certificates</a>
    </div>
    <a onclick="opens()">Emailing</a>
    <div id="email" style="display: none;">
      <a class="active" href="/home/event/email.html" target="fra1"> Bulk Emailing</a>
    </div>
